        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-2">
                ...
                <button
                    ...
                    onclick="toggleTheme()"
                    title="Toggle theme"
                    class="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition duration-150 ease-in-out"
                >
                    ...
                    {{--  iconMoon — visible in light mode --}}
                    <!-- <svg class="block dark:hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 100 14.586 8.003 8.003 0 0010.586-3z" />
                    </svg> -->

                    <svg class="block dark:hidden w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
            ...
            <div class="-me-2 flex items-center gap-1 sm:hidden">
                ...
                <button
                    ...
                    onclick="toggleTheme()"
                    title="Toggle theme"
                    class="p-2 rounded-full text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none transition duration-150 ease-in-out"
                >
